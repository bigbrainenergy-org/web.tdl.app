<script setup lang="ts">
  ...
  if (isNotArray(data.value)) throw new Error('ArrayComponent: data provided was not an array!')
  ...
  <div>
    ...
    <q-list v-if="data">
      <q-item v-for="(item, key) of data" :key="key">
        <LazyVueComponent :data="item" :name="name + key + ':'" :edit="edit" :show-edit="false" />
      </q-item>
    </q-list>
  </div>
</template>
