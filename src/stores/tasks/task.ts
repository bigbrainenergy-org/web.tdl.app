import { iOptions } from '../generics/i-record'
...
// class Task extends Model implements iRecord {
...
// class TaskRepo extends GenericRepo<CreateTaskOptions, UpdateTaskOptions, Task> {
//   override use = Task
//   override apidir = Task.entity
